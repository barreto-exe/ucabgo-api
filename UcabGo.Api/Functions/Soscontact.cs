...
namespace UcabGo.Api.Functions
{
    public class Soscontact
    {
        ...
        private readonly ISoscontactServices services;
        public Soscontact(ApiResponse apiResponse, ISoscontactServices services)
        {
        ...
        public async Task<IActionResult> UpdateSoscontacts(
            [HttpTrigger(AuthorizationLevel.Anonymous, "put", Route = "users/sos-contact")] HttpRequest req, ILogger log)
        {
